...
Departamento de Edición, CABA\par
\vspace{6pt}
{\bfseries\color{azulrevista!70}Derechos de autor\'ia:}\par
\textcopyright\ 2026 Freitas, S. Publicado por Revista Soma. CC BY 4.0 (\href{https://www.google.com/}{https://www.google.com/})\par\vspace{6pt}
...
{\scriptsize\texttt{\href{https://www.google.com/}{https://www.google.com/}}}\par
\vspace{6pt}
\vspace{6pt}
...
Se aplicó un cuestionario estructurado que relevó cuatro dimensiones del acceso digital, operacionalizadas a partir del modelo de van Dijk \autocite*{2564-VANDIJK2020} : acceso motivacional (escala de autoeficacia digital, 8 ítems, α = 0,87), acceso material (tipo de dispositivo principal, calidad de conexión, espacio de estudio), habilidades digitales (escala adaptada de van Deursen y van Dijk, \autocite*{2565-VANDEURSEN2019} , 12 ítems, α = 0,91) y resultados académicos (promedio ponderado del período 2020-2022, materias aprobadas por semestre). El componente cualitativo consistió en 40 entrevistas semiestructuradas (20 por universidad) con estudiantes que presentaban perfiles contrastantes en las variables de interés.
